 ...
 *
 * This file is part of Applic_Occupations.
 *
 * Applic_Occupations is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published
 * by the Free Software Foundation; either version 3 of the License,
 * or (at your option) any later version.
 *
 * Applic_Occupations is distributed in the hope that it will be useful, but
 * WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU
 * General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with Applic_Occupations; if not, write to the Free Software
 * Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA 02111-1307
 * USA
 */

package applic_occupations;
...
/**
 * Manage an {@link Applic_Occupations}
 * @author Sh1fT
 */
public class Applic_Occupations {
    private PropertiesLauncher propertiesLauncher;
    private SecretKey secretKey;
    private KeyPair keyPair;

    /**
     * Create a new {@link Applic_Occupations} instance
     */
    public Applic_Occupations() {
        this.setPropertiesLauncher(new PropertiesLauncher(
                System.getProperty("file.separator") + "properties" +
                System.getProperty("file.separator") + "Applic_Occupations.properties"));
    ...
    public static void main(String[] args) {
        try {
            ...
            Applic_Occupations ar = new Applic_Occupations();
            String cmd = ".4S&v";
            String cmdTemp = "";
            String response = "";
            String name = "";
            ...
            do {
                ...
                switch (cmd) {
                    ...
                    case "BDROOM":
                        ...
                        arrival = br.readLine();
                        signature = ar.genSignature("BDROOM_SIG").replace("\n", "");
                        listRooms = (String) ar.sendCmd(new String[] {cmd, arrival, signature});
                        ...
                        break;
                    case "ARRROOM":
                        System.out.println("~ Arrival Room ~");
                        System.out.println("Room's id: ");
                        idRoom = br.readLine();
                        System.out.println("Client name: ");
                        clientName = ar.encryptClientName(br.readLine());
                        signature = ar.genSignature("ARRROOM_SIG").replace("\n", "");
                        response = (String) ar.sendCmd(new String[] {cmd, idRoom, clientName,
                            signature});
                        switch (response) {
                            case "OK":
                                System.out.println("Arrival successfully executed :)");
                                break;
                            case "KO":
                                System.out.println("Arrival not successfully executed :(");
                                break;
                            default:
                                break;
                        }
                    ...
                    case "MISROOM":
                        ...
                        System.out.println("Client name: ");
                        clientName = ar.encryptClientName(br.readLine());
                        signature = ar.genSignature("MISROOM_SIG").replace("\n", "");
                        response = (String) ar.sendCmd(new String[] {cmd, idRoom, clientName,
                            signature});
                        switch (response) {
                            case "OK":
                                System.out.println("Missing successfully executed :)");
                                break;
                            case "KO":
                                System.out.println("Missing not successfully executed :(");
                                break;
                            default:
                                break;
                        }
